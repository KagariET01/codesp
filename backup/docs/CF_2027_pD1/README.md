# [`CF 2027 pD1`](https://codeforces.com/contest/2027/problem/D1) The Endspeaker (Easy Version)
## 標籤
...
int main(){
	...
	while(t--){
		...
		cout<<(dp[n][m]>=1e10?-1:dp[n][m])<<endl;
	}
	return 0;
}
