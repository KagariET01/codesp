# [`AT abc351 pB`](https://atcoder.jp/contests/abc351/tasks/abc351_B) Spot the Difference
## 標籤
...
//list
template<typename T,const std::size_t N>istream&operator>>(istream&in,T(&a)[N]){
	for(T&i:a)in>>i;
	return in;
}
